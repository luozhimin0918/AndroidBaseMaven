...
/**
 * Created by JerryWang on 2017/2/24.
 */
...
public class RoundProgressBar extends View {
     ...
     * 最大进度
     */
    private double max = 100.00d;

    /**
     * 当前进度
     */
    private double progress = 0.00d;
    /**
     * 是否显示中间的进度
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i("AAA", "max: " + max);
        double percent = progress * 100/ max ;  //中间的进度百分比，先转换成float在进行除法运算，不然都为0
        Log.i("AAA" ,"percent: "+ percent);
